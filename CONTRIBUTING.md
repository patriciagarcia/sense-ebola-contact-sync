...
[GitHub issue tracker]: https://github.com/eHealthAfrica/sense-ebola-contact-sync/search?type=Issues
[reduced test case]: http://css-tricks.com/reduced-test-cases
[new issue]: https://github.com/eHealthAfrica/sense-ebola-contact-sync/issues/new
...
1. Clone and fork the project
    ...
    ```bash
    git clone eHealthAfrica/sense-ebola-contact-sync
    cd sense-ebola-contact-sync
    git fork
    ```
...
[the repo]: https://github.com/eHealthAfrica/sense-ebola-contact-sync
